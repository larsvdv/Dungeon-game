...
public class game {
    public static void main(String[] args) {
        ...
        //Game variables
        String[] enemies = {"Maitsjol", "Roobn", "Geff", "Larnsiboi", "ferre39"};
        ...
        while (running) {
            ...
            if(health < 1) {
                System.out.println("You run out of the dungeon, to weak to battle");
                break;
            }
            ...
            if(input.equals("1")) {
                System.out.println("You continue battling!");
            }
            else if(input.equals("2")) {
